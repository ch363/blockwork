...
const PATHS = {
  ...
  /** Export: arrow out of a box. */
  export: ['M8 6H5a2 2 0 00-2 2v11a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-3', 'M12 16V3', 'M8 7l4-4 4 4'],
  /** Import: arrow into a box. */
  import: ['M8 6H5a2 2 0 00-2 2v11a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-3', 'M12 3v13', 'M8 12l4 4 4-4'],
  /** Exit: door with arrow. */
  exit: ['M14 8V6a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2h7a2 2 0 002-2v-2', 'M7 12h14', 'M18 8l4 4-4 4'],
  /** Settings: gear. */
  settings: [
